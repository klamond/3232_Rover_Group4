...
void movement_parse_502(void) {
    uint16_t Raw_X_Axis = ((uint16_t)comms_payload[1] << 8) | comms_payload[0];
    uint16_t Raw_Y_Axis = ((uint16_t)comms_payload[3] << 8) | comms_payload[2];

    int16_t X_Centered = (int16_t)(Raw_X_Axis - 1500);
