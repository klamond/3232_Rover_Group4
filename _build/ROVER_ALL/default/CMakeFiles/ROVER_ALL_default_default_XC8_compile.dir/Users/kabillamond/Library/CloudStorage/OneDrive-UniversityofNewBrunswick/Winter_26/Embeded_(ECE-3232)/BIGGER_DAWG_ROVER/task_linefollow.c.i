# 1 "/Users/kabillamond/Library/CloudStorage/OneDrive-UniversityofNewBrunswick/Winter 26/Embeded (ECE-3232)/BIGGER_DAWG_ROVER/task_linefollow.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 295 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "/Users/kabillamond/Library/CloudStorage/OneDrive-UniversityofNewBrunswick/Winter 26/Embeded (ECE-3232)/BIGGER_DAWG_ROVER/task_linefollow.c" 2
...
# 2 "/Users/kabillamond/Library/CloudStorage/OneDrive-UniversityofNewBrunswick/Winter 26/Embeded (ECE-3232)/BIGGER_DAWG_ROVER/task_linefollow.c" 2
...
# 3 "/Users/kabillamond/Library/CloudStorage/OneDrive-UniversityofNewBrunswick/Winter 26/Embeded (ECE-3232)/BIGGER_DAWG_ROVER/task_linefollow.c" 2
...
# 4 "/Users/kabillamond/Library/CloudStorage/OneDrive-UniversityofNewBrunswick/Winter 26/Embeded (ECE-3232)/BIGGER_DAWG_ROVER/task_linefollow.c" 2
# 20 "/Users/kabillamond/Library/CloudStorage/OneDrive-UniversityofNewBrunswick/Winter 26/Embeded (ECE-3232)/BIGGER_DAWG_ROVER/task_linefollow.c"
...
static void drive_signed(int16_t left, int16_t right)
{
    ...
    if (left == 0) {
        ...
        dirA = 1; speedA = (uint8_t)left;
    } else {
        dirA = 2; speedA = (uint8_t)(-left);
    }
    ...
    if (right == 0) {
        ...
        dirB = 2; speedB = (uint8_t)right;
    } else {
        dirB = 1; speedB = (uint8_t)(-right);
    }
...
static void line_follow_update(void)
{
    ...
    if (M && !L && !R) {
        ...
        last_dir = 1;
        recover_count = 0;
        if (slow_cycle) drive_signed(-55, 55);
        else drive_signed(-70, 70);
    }
    else if (L && !M && !R) {
        last_dir = 1;
        recover_count = 0;
        if (slow_cycle) drive_signed(-60, 60);
        else drive_signed(-80, 80);
    }
    else if (!L && M && R) {
        last_dir = -1;
        recover_count = 0;
        ...
        recover_count = 0;
        if (last_dir > 0) {
            if (slow_cycle) drive_signed(-65, 65);
            else drive_signed(-65, 60);
        } else if (last_dir < 0) {
            if (slow_cycle) drive_signed(65, -65);
            else drive_signed(60, -65);
        } else {
            if (slow_cycle) drive_signed(60, 60);
            else drive_signed(65, 65);
        }
    }
    else {
        ...
        if (recover_count < 2) {
            ...
            if (last_dir > 0) {
                if (slow_cycle) drive_signed(75, -75);
                else drive_signed(70, -70);
            } else if (last_dir < 0) {
                if (slow_cycle) drive_signed(-75, 75);
                else drive_signed(-70, 70);
...
void linefollow_init(void)
{
    ...
    TRISBbits.TRISB0 = 1; ANSELBbits.ANSB0 = 1;
    TRISBbits.TRISB1 = 1; ANSELBbits.ANSB1 = 1;
    TRISBbits.TRISB2 = 1; ANSELBbits.ANSB2 = 1;
